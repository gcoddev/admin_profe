                            ...
                            <form action="{{ route('admin.inscripcion.store') }}" method="POST">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        placeholder="Ingrese el nombre" value="{{ $inscripcion->per_nombre1.' '.$inscripcion->per_nombre2 }}" readonly>
                                    </div>
                                    <div class="col-sm-1 col-form-label">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        placeholder="Ingrese el apellido" value="{{ $inscripcion->per_apellido1.' '.$inscripcion->per_apellido2 }}" readonly>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-3 col-sm-12">
                                        <label for="correo_nombre">Nombre del Correo</label>
                                        <input type="text" class="form-control" id="correo_nombre"
                                        name="correo_nombre" placeholder="Ingrese el nombre del correo"
                                        >
                                    </div>
                                    <div class="form-group col-md-3 col-sm-12">
                                    ...
                                    <div class="form-group col-md-3 col-sm-12">
                                        ...
                                        name="per_correo" placeholder="Correo Completo" value="{{ $inscripcion->per_correo }}" readonly>
                                    </div>
                                    <div class="form-group col-md-3 col-sm-12">
                                        <label for="per_celular">Celular</label>
                                        <input type="number" class="form-control" id="per_celular" name="per_celular"
                                            value="{{ $inscripcion->per_celular }}"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="sede_id" id="sede" class="form-control">
                                            ...
                                            @foreach ($sede as $s)
                                            <option value="{{ $s->sede_id }}" {{ $inscripcion->sede_id == $s->sede_id ? 'selected' : '' }}>{{ $s->sede_nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <select name="pro_id" id="programa" class="form-control">
                                            ...
                                            <option value="{{ $prog->pro_id }}" {{ $inscripcion->pro_id == $prog->pro_id ? 'selected' : '' }}>{{ $prog->pro_nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            success: function(response) {
                                ...
                                if (response.length > 0) {
                                    response.forEach(function(turno) {
                                        $('#turno').append(
                                            `<option value="${turno.pro_tur_id}" ${ $inscripcion->pro_tur_id == $turno->pro_tur_id ? 'selected' : '' }>${turno.pro_tur_nombre}</option>
                                            `
                                            );
                                    });
                                }

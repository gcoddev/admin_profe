                        ...
                        <div class="card-block">
                            <div class="row align-items-end">
                                <div class="col-8">
                                    ...
                                    <h3 class="text-white m-b-0">Downloads</h3>
                                </div>
                                <div class="col-4 text-right">
                ...
                {{-- <div class="col-xl-9 col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <span class="text-muted">For more details about usage, please refer
                                            <a href="https://www.amcharts.com/online-store/" target="_blank">amCharts</a>
                                            licences.</span>
                                    ...
                                    <div class="card-block">
                                        <div class="row m-b-25">
                                            ...
                                            <div class="col">
                                                ...
                                                <p class="text-muted m-b-0">
                                                    <i class="feather icon-clock m-r-10"></i>2
                                                    min ago
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="latest-update-box">
                                            ...
                                            <div class="row p-b-15">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <p class="text-muted m-b-0">
                                                        Download the
                                                        <span class="text-c-blue">latest backup</span>.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row p-b-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <h6 class="text-muted f-w-400">
                                                            <a href="https://demo.dashboardpack.com/cdn-cgi/l/email-protection"
                                                                class="__cf_email__"
                                                                data-cfemail="0c666962754c6b616d6560226f6361">[email&#160;protected]</a>
                                                        </h6>
                                                    </div>
                                                    <div class="col-sm-6">

                    ...
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            <div class="d-inline">
                                ...
                                <span>Lista de Unidad Educativa existentes</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item" style="float: left">
                                    <a href="#!">Lista de Unidad Educativa</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ route('migration.unidadeducativa.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="card-block">
                                <div class="dt-responsive table-responsive">
                                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @foreach ($unidadeducativas as $unidadeducativa)
                                                <tr>
                                                    <td>{{ $loop->index + 1 }}</td>
                                                    <td>{{ $unidadeducativa->uni_edu_codigo }}</td>
                                                    <td>{{ $unidadeducativa->uni_edu_nombre }}</td>
                                                    <td>{{ $unidadeducativa->uni_edu_estado }}</td>
                                                    <td>{{ $unidadeducativa->updated_at }}</td>

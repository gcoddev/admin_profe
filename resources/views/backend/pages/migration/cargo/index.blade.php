                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            <div class="d-inline">
                                <h4>Cargos</h4>
                                <span>Lista de Cargos existentes</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ route('migration.cargo.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf

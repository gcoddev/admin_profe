                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            <div class="d-inline">
                                <h4>Departamentos</h4>
                                <span>Lista de departamentos existentes</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item" style="float: left">
                                    <a href="#!">Lista de Departamentos</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ route('migration.departamento.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
